...
"""
button_alpha_style = """
    QPushButton {background: rgb(70,80,100); color: rgba(255,255,255,0.5); border: 1px solid rgb(70,80,100); 
    padding: 2px 2px; border-radius: 0px; font: 9pt \"微软雅黑\"; min-width: 60px; height: 20px;}
    QPushButton:hover { background-color: #379eff; border: 1px solid #379eff; border-radius: 0px;}
"""
lineedit_style = """
...
"""
branch_select_listwidget_qdarkstyle = z_list_qdarkstyle = """
...
"""
layer_list_style = fun_list_style = branch_list_style = """
...
"""
layer_widget_style = fun_widget_style = branch_widget_style = """
...
"""
label_count_style = """
    QLabel {color: #4C9C4C; font-size: 11pt \"微软雅黑\";}
"""
filter_nums_label_style = """
    QLabel {color: rgb(255, 255, 0); font-size: 11pt \"微软雅黑\";}
"""
