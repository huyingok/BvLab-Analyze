...
from VesselUnet3D.models.model import LoadModel
from torch.utils.data import DataLoader
from VesselUnet3D.DataLoader import GetMultiTypeMemoryDataSetAndCropQxz
import numpy as np
import torch
from tensorboardX import SummaryWriter
from VesselUnet3D.Net import Trainer
from VesselUnet3D.MyUtil import GetLossOptimiLr
...
class VesselTrainQThread(QThread):
    ...
    def __init__(self, *args, **kwargs):
        super(VesselTrainQThread, self).__init__()
    ...
    def run(self):
        try:
            ...
            savePath = join(exe_cfg.cfg['ExePath']['vessel_models_path'], f"{expName}")  # 模型保存路径
