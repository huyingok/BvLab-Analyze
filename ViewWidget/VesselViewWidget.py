...
from vessel_lines_marking.CreateImageData import CreateImageData
from vessel_lines_marking.CreateDialog import CreateDialog
from vessel_lines_marking.ReadPath import ReadPath
from vessel_lines_marking.SetConnect import SetConnect
from vessel_lines_marking.MarkingPointsFun import MarkingPointsFun
from vessel_lines_marking.MarkProcess import MarkProcess
from vessel_lines_marking.GrayAdjustWidget import GrayAdjustWidget
from vessel_lines_marking.CustomMainWindow import MyWidget
from vessel_lines_marking.InitializeInfo import InitializeInfo
from vessel_lines_marking.ControlStyle import (messagebox_style, lines_button_show_style, image_button_show_style,
                                               image_button_hide_style,
                                               button_alpha_style, button_style)
from BVExample.BVMoudle.BVMoudle import BVReader
from vessel_lines_marking.MarkingPointsFun import nearest_point_to_line_fast


class VesselViewWidget(MyWidget, CreateDialog):
    def __init__(self, parent=None):
        super(VesselViewWidget, self).__init__(parent)
