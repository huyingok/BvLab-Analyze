...
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QPushButton, QHBoxLayout, QSpacerItem
from PyQt5.QtCore import Qt, QPoint
from ControlStyle import menubar_style, menu_style, titleLabel_style
import os
import sys
...
class CustomTitleBar(QWidget):
    ...
    def menubar_message(self):
        ...
        self.open_file_act.setShortcut("Ctrl+Q")
        ...
        self.mark_withdraw_act = QtWidgets.QAction(self.hide_bar)
        self.mark_withdraw_act.setShortcut('Z')
        self.actor_delete_act = QtWidgets.QAction(self.hide_bar)
        self.actor_delete_act.setShortcut('D')
        self.actor_all_delete_act = QtWidgets.QAction(self.hide_bar)
        self.actor_all_delete_act.setShortcut('C')
        self.actor_all_delete_limit_act = QtWidgets.QAction(self.hide_bar)
        self.actor_all_delete_limit_act.setShortcut('Alt+D')
        self.volume_change_act = QtWidgets.QAction(self.hide_bar)
        self.volume_change_act.setShortcut('Q')
        self.new_mark_create_act = QtWidgets.QAction(self.hide_bar)
        self.new_mark_create_act.setShortcut('R')
        ...
        self.sphere_quick_key_act.setShortcut('A')
        self.outline_quick_key_act = QtWidgets.QAction(self.hide_bar)
        self.outline_quick_key_act.setShortcut('B')
        self.gray_auto_change_act = QtWidgets.QAction(self.hide_bar)
        self.gray_auto_change_act.setShortcut('G')
        self.gray_limit_change_act = QtWidgets.QAction(self.hide_bar)
        self.gray_limit_change_act.setShortcut('T')
        ...
        self.start_marking_act = QtWidgets.QAction(self.hide_bar)
        self.start_marking_act.setShortcut('V')
        self.end_marking_act = QtWidgets.QAction(self.hide_bar)
        self.end_marking_act.setShortcut('S')
        ...
        self.hide_bar.addAction(self.mark_withdraw_act)
        self.hide_bar.addAction(self.actor_delete_act)
        self.hide_bar.addAction(self.actor_all_delete_act)
        self.hide_bar.addAction(self.actor_all_delete_limit_act)
        self.hide_bar.addAction(self.volume_change_act)
        self.hide_bar.addAction(self.new_mark_create_act)
        self.hide_bar.addAction(self.change_function_act)
        self.hide_bar.addAction(self.sphere_quick_key_act)
        self.hide_bar.addAction(self.outline_quick_key_act)
        self.hide_bar.addAction(self.gray_auto_change_act)
        self.hide_bar.addAction(self.gray_limit_change_act)
        self.hide_bar.addAction(self.camera_focal_act)
        self.hide_bar.addAction(self.sure_gray_auto_act)
        self.hide_bar.addAction(self.start_marking_act)
        self.hide_bar.addAction(self.end_marking_act)
