...
from Seg_Net_main_PyQt.LossPy import BCEDiceLoss, ComputePR, LSDLoss, EvalScore, DistLSDLoss, DistEvalScore
from torch import nn as nn

def GetLossOptimiLr(model, th):
    optimizer_config = {
    ...
    # Evaluate
    eval_PR = ComputePR(0.5, 0.5, 0)
    # eval_metric = nn.L1Loss(reduction='none')
    # eval_metric = LSDLoss()
    # eval_metric = EvalScore()
    eval_metric = DistEvalScore(th)
    return loss_criterion, optimizer, lr_scheduler, eval_metric, eval_PR
