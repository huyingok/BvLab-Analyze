...
from PyQt5.QtGui import QKeySequence, QMouseEvent, QFont
from cell_points_marking.Ui_ShortCutDialog import Ui_ShortCutDialog
from cell_points_marking.ControlStyle import messagebox_style, button_style, lineedit_style, images_list_qdarkstyle
