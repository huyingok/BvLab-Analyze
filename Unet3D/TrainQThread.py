...
from Unet3D.LossPy import LSDLoss, EvalScore
...
class NeuralDataTrainQThread(QThread):
    ...
    def __init__(self, *args, **kwargs):
        super(NeuralDataTrainQThread, self).__init__()
    ...
    def _load_training_data(self):
        ...
        train_loader = DataLoader(
            train_dataset, batch_size=self.batchSize, shuffle=True, num_workers=0
        )
        ...
        val_loader = DataLoader(
            val_dataset, batch_size=self.batchSize, shuffle=True, num_workers=0
        )
    ...
    def _record_training_loss(self, epoch, kk, train_small_losses):
        ...
        # print('Loss/TrainSmallLoss', train_small_losses.id + self.small_epoch)
    ...
    def _perform_validation(self, epoch, train_big_losses, evalVal, lastEvalVal, view_count, patience_counter):
        ...
        # print('Loss/TrainBigLoss', train_big_losses.id + self.big_epoch)
        self.model.eval()
        try:
            with torch.no_grad():
                ...
                # print('Eval/EvalVal', evalVal.id + self.eval_epoch)
                ...
                # print('TrainParam/Lr', evalVal.id + self.eval_epoch)
    ...
    def train_init(self):
        ...
        self.modelPath = join(exe_cfg.cfg['ExePath']['neural_models_path'], f"{expName}")  # 模型保存路径
